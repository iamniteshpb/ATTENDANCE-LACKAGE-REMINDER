...
book = openpyxl.load_workbook('/content/sample_data/Book1.xlsx')
...
# staff mail ids
staff_mails = ['niteshalexa001@gmail.com', 'yyyyyyyy@gmail.com']
  
# Warning messages
m1 = "warning!!! your son/daughter can take only one more day leave for CI class as he/she was absent for today's period"
m2 = "warning!!! your son/daughter can take only one more day leave for PYTHON class as he/she was absent for today's period"
m3 = "warning!!! your son/daughter can take only one more day leave for DM class as he/she was absent for today's period"
  
  
def savefile():
    book.save(r'/content/sample_data/Book1.xlsx')
    print("saved!")
...
def mailstaff(mail_id, msg):
    from_id = 'nitesh.cs21@bitsathy.ac.in'
    pwd = '987654321'
    to_id = mail_id
    message = MIMEMultipart()
